...
import tanvd.jetaudit.model.external.types.objects.ObjectType.TypesResolution.addType
...
internal class SavingTest {
    ...
    private val typeTestClassLong = ObjectType(TestClassLong::class, TestClassLongPresenter) as ObjectType<Any>
    private val typeTestClassString = ObjectType(TestClassString::class, TestClassStringPresenter) as ObjectType<Any>
