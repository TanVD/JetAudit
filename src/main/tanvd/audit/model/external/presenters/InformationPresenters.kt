...
object TimeStampPresenter : InformationLongPresenter() {
    ...
    override val code = PropertyLoader.loadProperty("TimeStampColumn") ?: "TimeStampColumn"
...
object VersionPresenter : InformationLongPresenter() {
    ...
    override val code = PropertyLoader.loadProperty("VersionColumn") ?: "VersionColumn"
...
object IdPresenter : InformationLongPresenter() {
    ...
    override val code = PropertyLoader.loadProperty("IdColumn") ?: "IdColumn"
...
object DatePresenter : InformationDatePresenter() {
    ...
    override val code = PropertyLoader.loadProperty("DateColumn") ?: "DateColumn"
